...
<template>
  <div>
    <!-- justify-content:space-between空格放中间-->
...
export default {
    ...
    methods:{
        showEditSalaryView(data){
            ...
            this.activeItemIndex=0;             //默认激活的索引也要初始化
            this.salary.id=data.id;                //初始化
            ...
            this.salary.pebsionBase=data.pebsionBase;
 ...
               })
        ...
        nextStep(){
            ...
            if(this.activeItemIndex==10){
                if(this.salary.id){  //存在id是编辑，否则是添加
